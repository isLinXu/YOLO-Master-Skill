...
from runtime.cli.lora_tools import (
    LoraDiagnoseDeps,
    run_lora_diagnose as run_lora_diagnose_impl,
)
...
from runtime.cli.model_handlers import (
    ModelDeps,
    run_model_inspect as run_model_inspect_impl,
)
from runtime.cli.moe_tools import run_moe_diagnose, run_moe_prune
from runtime.cli.peft_compare import (
    PeftCompareDeps,
    run_peft_compare as run_peft_compare_impl,
)
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Structured dispatcher for the YOLO-Master agent skill."
    )
